...
# train/eval config
eval_cfg = dict(split=None, image_size=224, batch_size=16, steps=None)
...
loss_cfg = dict(xent_type="softmax", label_smoothing=0.1)
...
class Vision(Base):
    ...
    # initialization
    cfg.init = dict(warm_start_mode="restore_train", warm_start_from=None)
